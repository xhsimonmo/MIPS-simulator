...
private:
    ...
    void addiu(int rt, int rs,int32_t sign_imm, std::vector<uint32_t> &reg);
    ...
    void beq(int rt, int rs, int32_t sign_imm, uint32_t& pc, uint32_t& tmp_pc,std::vector<uint32_t> &reg, bool& delay);
    void bgez(int rs, int32_t sign_imm, uint32_t& pc,uint32_t& tmp_pc, std::vector<uint32_t> &reg, bool& delay);
    void bgezal(int rs, int32_t sign_imm, uint32_t& pc,uint32_t& tmp_pc, std::vector<uint32_t> &reg, bool& delay);
    void bgtz(int rs, int32_t sign_imm, uint32_t& pc, uint32_t& tmp_pc,  std::vector<uint32_t> &reg, bool& delay);
    void blez(int rs, int32_t sign_imm, uint32_t& pc,  uint32_t& tmp_pc, std::vector<uint32_t> &reg, bool& delay);
    void bltz(int rs, int32_t sign_imm, uint32_t& pc, uint32_t& tmp_pc,  std::vector<uint32_t> &reg, bool& delay);
    void bltzal(int rs, int32_t sign_imm, uint32_t& pc, uint32_t& tmp_pc,  std::vector<uint32_t> &reg, bool& delay);
    void bne(int rt, int rs, int32_t sign_imm, uint32_t& pc, uint32_t& tmp_pc, std::vector<uint32_t> &reg, bool& delay);
    ...
    void sltiu(int rs,int rt,int32_t sign_imm, std::vector<uint32_t> &reg);
    ...
    void mthi(int rs, std::vector<uint32_t> &reg, uint32_t &reg_hi);
    void mtlo(int rs, std::vector<uint32_t> &reg, uint32_t &reg_lo);
